...
/**
 * CDI producer for the archive {@link BlobContainerClient}.
 *
 * <p>The produced client is qualified with {@link ArchiveBlobContainer} to distinguish it from
 * the Alfresco and storage container clients in the same WAR deployment.
 */
@ApplicationScoped
public class ArchiveAzureBlobContainerClientProducer {
