...
public class UploadFileAsPdfRulesTest extends BaseDroolsAccessControlTest {
    ...
    public UploadFileAsPdfRulesTest() {
    ...
    @BeforeEach
    public void setUp() {
        action = createActionFor("material.command.upload-file-as-pdf");
    }
    ...
    @Test
    public void shouldNotAllowFileUploadWhenCallerDoesNotBelongToAnyAllowedGroup() {
