...
public class CreateMaterialBundleRulesTest extends BaseDroolsAccessControlTest {
    ...
    public CreateMaterialBundleRulesTest() {
    ...
    @BeforeEach
    public void setUp() {
        action = createActionFor("material.command.handler.create-material-bundle");
    }

    @Test
    public void shouldAllowCreateBundle() {
